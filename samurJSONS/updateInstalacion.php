...
if(isset($parameters)){
	...
	if(JSONCorrectoAnnadir($mensajeRecibido)){
		...
		$instalacion = $mensajeRecibido["instalacionUpdate"]; 
        ...
        $query  = "UPDATE `instalacion` ";
        $query .= "SET `nombre`='$nombre', `telefono`='$telefono', `direccion`='$direccion'";
        $query .= " WHERE `codparque`='$codparque'";
